...
Dart._Evaluation = class {
    ...
    async url() {
        ...
        // TODO: How do we handle part files?
    ...
    async currentLibrary() {
        // TODO: Something more reliable and less heuristic.
    ...
    /// the $dartLoader data structures in the application.  TODO: Make this
    /// less dependent on the module system, or have a version for AMD.
    async _currentModuleId() {
        ...
        const module = await this.callFrame.evaluate(
            {
                expression: '$dartLoader.urlToModuleId.get("' + url + '")',
                silent: true,
                returnByValue: true,
                generatePreview: false
            },
    ...
    async variableNames() {
        ...
        for (const scope of environments) {
            ...
            allNames.push(...prefixed); // TODO: shadowing
        }
        return allNames;
    }
