...
Dart._JsScopeChain = class {
    ...
    async toDartScopeChain() {
        ...
        // TODO: Is there always an active library? Can we rely on having bailed
        // out well before this if we're in a JS scope.
...
Dart._ThisScope = class _ThisScope extends Dart._Scope {
    ...
    /// @return {Dart._ThisScope}
    withoutIgnored() {
        // TODO: Make this more rigorous, especially the _is_<className> check.
        // TODO: Will this handle private superclass fields. Do we see those
        // symbols?  They might be in a separate package, but we may want to
        // include them and assume that dloadRepl will handle them.
